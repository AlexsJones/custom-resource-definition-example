...
import (
	...
	"github.com/AlexsJones/custom-resource-definition-example/pkg/client/clientset/versioned/scheme"
...
// MetadataV1Client is used to interact with features provided by the metadata group.
type MetadataV1Client struct {
	restClient rest.Interface
}

func (c *MetadataV1Client) MetaDataContextTypes(namespace string) MetaDataContextTypeInterface {
	return newMetaDataContextTypes(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*MetadataV1Client, error) {
	...
	return &MetadataV1Client{client}, nil
}

// NewForConfigOrDie creates a new MetadataV1Client for the given config and
